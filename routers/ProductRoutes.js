...
const { getAllProduct, getSingleProduct, creareProduct, updateProduct, updateProductImage, deleteProductImage, deleteProduct } = require('../controllers/ProductController');
